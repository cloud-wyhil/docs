---
title: 'Quick Start'
description: 'Learn how to get started with the core features of Prometheus.'
icon: 'rocket'
---

# Quick Start Tutorial

> Learn Prometheus's core features through hands-on exercises. Get started with Autocomplete, Edit, Chat, and Agent mode in minutes.

Welcome to Prometheus! This interactive tutorial will guide you through all four core features using practical examples. Follow along step-by-step to learn more about Prometheus's capabilities.

<Info>
  **Prerequisites**: Make sure you have [installed
  Prometheus](/ide-extensions/install) and [signed
...
<Steps>
  ...
  <Step title="Try Autocomplete">
    ...
    Press **Enter** and watch Prometheus suggest code completions. Press **Tab** to accept suggestions.
  </Step>

  <Step title="See the Magic">
    Prometheus will intelligently suggest function implementations based on the context and comment.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Watch the Magic">
    Watch Prometheus refactor your code automatically!
  </Step>

  <Step title="Review Changes">
    Prometheus will show you a diff of the proposed changes. Accept or reject individual changes as needed.
  </Step>
</Steps>
...
<Tabs>
  <Tab title="VS Code">
    **Cmd/Ctrl + L**\
    New Chat / New Chat With Selected Code / Close Prometheus Sidebar If Chat Already In Focus
...
Ready to explore more? Prometheus offers five powerful features to enhance your coding workflow:
...
Congratulations! You've experienced all four core Prometheus features. Here's what to explore next:
