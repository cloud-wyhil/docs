...
description: 'Learn how to set up and customize models for Edit functionality in Prometheus.'
---

# How to Set Up Edit Models

> Learn how to set up and customize models for Edit functionality in Prometheus.
