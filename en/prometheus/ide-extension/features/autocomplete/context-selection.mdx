...
description: 'Learn how Prometheus selects relevant code context in Chat Mode.'
---
...
> Learn how Prometheus's autocomplete selects relevant code context using file content, language server definitions, imports, and recent file history.
