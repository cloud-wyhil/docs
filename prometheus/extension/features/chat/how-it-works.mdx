...
description: 'Learn how Chat Mode works in Prometheus and how it differs from Agent Mode'
---

# How Chat Works

> Prometheus's Chat feature provides a conversational interface with AI models directly in your IDE sidebar.

## How Chat Core Functionality Works

When you start a chat conversation, Prometheus:
