...
description: 'Learn how Prometheus edit functionality works by using highlighted code and file context to prompt the model for code modifications.'
---
...
When you start an edit session, Prometheus:
