...
# Recommended Models for Chat in Prometheus

> Choose the best chat model for Prometheus, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models.
