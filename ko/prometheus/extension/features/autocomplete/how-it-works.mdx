---
title: 'How Autocomplete Works in Prometheus'
description: 'Learn how Prometheus autocomplete works and how it differs from Agent Mode'
---


# How Autocomplete Works in Prometheus

> Understand how Prometheus's autocomplete works, including timing optimization, context retrieval from your codebase, and filtering to improve AI code suggestions.
...
Prometheus uses a number of retrieval methods to find relevant snippets from your codebase to include in the prompt.
