---
title: 'Recommended Models for Autocomplete in Prometheus'
description: 'Choose the best autocomplete model for Prometheus, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models.'
---

# Recommended Models for Autocomplete in Prometheus

> Choose the best autocomplete model for Prometheus, including hosted high-performance options, fast speed/quality tradeoffs, and local privacy-first models.
...
For proactive code prediction that anticipates your next edit, Prometheus supports specialized [Next Edit](/ide-extensions/autocomplete/next-edit) models:
