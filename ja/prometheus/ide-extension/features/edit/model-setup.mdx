---
title: 'エディットモデルの設定方法'
description: 'Prometheusのエディット機能のためのモデルの設定とカスタマイズ方法について学びます。'
---

# エディットモデルの設定方法

> Prometheusのエディット機能のためのモデルの設定とカスタマイズ方法について学びます。
...
チャットモード用に設定したモデルが、デフォルトでエディットモードでも使用されます。
...
<Info>
  エディットや適用など、各ロールに最適なモデルについては、[推奨モデルの包括的なガイド](/customize/models#recommended-models)をご覧ください。
</Info>

## 適用（Apply）モデルの設定方法

最高のエディット体験を得るために、適用（Apply）モデルの設定もお勧めします。

推奨される適用モデルについては、[推奨モデルのページ](/customize/models)を参照してください。

## モデルの互換性を判断する方法

どのモデルがどの機能をサポートしているかの完全な概要については、[モデル機能ガイド](/customize/deep-dives/model-capabilities)をご覧ください。
